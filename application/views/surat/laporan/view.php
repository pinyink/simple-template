    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <?php echo form_open('', 'id="form_add", class="form-horizontal"'); ?>  
                ...
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-7 col-xs-7">
                      <input class="form-control" name="tgl" id="tgl" autocomplete="off" value="<?php echo $tgl; ?>" required/>
                    </div>
                  </div>
                </div>
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-7 col-xs-7">
                      <select name="jenis" class="form-control" required>
                        ...
                        <?php if ($jenis == 1): ?>
                        <option value="1" selected>Surat Keluar</option>
                        <option value="2">Surat Masuk</option>
                        <?php elseif ($jenis == 2): ?>
                        <option value="1">Surat Keluar</option>
                        <option value="2" selected>Surat Masuk</option>
                        <?php else: ?>
                        <option value="1">Surat Keluar</option>
                        <option value="2">Surat Masuk</option>
                        <?php endif ?>
