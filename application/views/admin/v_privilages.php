  			...
  			<div class="modal-body form">
  				<div class="row" id="row_fa">
  					<div class="col-md-12 col-sm-12 col-xs-12" id="modal_form">
  						<?=
								form_open('admin/priv/add_priv', 'id="form_add" class="form-horizontal"');
							?>
  						<input type="hidden" value="" name="inputIdPriv" />
  						<div class="form-body">
  							<div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-3">Name Privilages</label>
  								<div class="col-md-7 col-sm-7 col-xs-7"><input name="inputDescPriv" placeholder="Name Privilages" class="form-control" type="text"></div>
  							</div>
  						</div>
  						<div class="form-body">
  							<div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-3">Description more</label>
  								<div class="col-md-7 col-sm-7 col-xs-7"><textarea class="form-control" name="inputDescPrivMore"></textarea></div>
  							</div>
  						</div>
  						<?=
								form_close();
